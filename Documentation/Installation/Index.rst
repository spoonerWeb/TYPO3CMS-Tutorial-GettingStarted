...
If you do not have a web server, you need to run one on your local machine.
You can find detailed information at `the Installation Guide
<https://docs.typo3.org/typo3cms/InstallationGuide/>`_.
